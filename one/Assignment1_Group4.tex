...
This algorithm gives the agent insight in the consequences taking each action has. Thican help the agent in deciding which action to take according to its policy. 
